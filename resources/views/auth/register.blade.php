...
@section('content')
    ...
    <div class="register-page" style="height: 90%; background-color: grey;">
        <img src="{{ asset('/img/universitas-logo_1.png') }}" alt="back" class="brand-image img-circle elevation-1">
        <div class="register-box">
            <div class="register-logo">
                <a href="/home/"><b>UNIVERSITAS</b> PAHLAWAN</a>
                <p>DAFTAR</p>
            </div>
            ...
            <div class="card">
                <div class="card-body register-card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="input-group mb-3 addremoved" id="sn">
                            ...
                            <input id="nrp" type="text" class="form-control" name="nrp" value="{{ old('nrp') }}"
                                placeholder="Enter NIM" maxlength="20">
                        ...
                        <div class="input-group mb-3 addremoved" id="ln">
                            ...
                            <input id="nip" type="text" class="form-control" name="nip" value="{{ old('nip') }}"
                                placeholder="Enter NIP" maxlength="20">
                    ...
                    <a class="nav-link btn btn-app font-weight-bolder   " href="{{ route('login') }}">Sudah Punya Akun ?</a>
